...
bulletImage = loadImage("assets/asteroids_bullett.png");
shipImage = loadImage("assets/asteroids_ship0001.png");
particleImage = loadImage("assets/asteroids_particle1.png");
...
function createAsteroid(type, x, y) {
  ...
  var img  = loadImage("assets/asteroid"+floor(random(0,6))+".png");
  a.addImage(img);
